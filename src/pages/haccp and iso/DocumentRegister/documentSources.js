...
export function getAutoImportedDocs() {
  ...
  out.push({
    ...
    type: "Manual",
    category: "Manual",
    isoClause: "ISO 22000:2018 clauses 4-10 / HACCP Plan",
    owner: "Food Safety Team Leader",
    issueDate: "08/05/2026",
    revision: "2.1",
    facility: "All Sites",
    storage: "FSMS portal / HACCP Manual module / controlled PDF export",
    distribution: "Top Management / QA / HACCP Team / Authorized users",
    retentionYears: 5,
    status: "Active",
    nextReviewDate: "08/05/2027",
    approvedBy: "Executive Manager",
    notes: "Master controlled FSMS manual. Section edits are retained as controlled overrides and automatically logged in Change Management Log.",
    sopId: null,
    sopNumber: "Manual",
  });
