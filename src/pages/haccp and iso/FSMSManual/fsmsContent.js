...
// Source: TELT-FSMS-MN-01 Rev. 2.1 / 08-05-2026 (Rev 2.1 closes SGS Stage 2 Major NC #1 — e-signatures captured)
...
export const FSMS_META = {
  ...
  revision: "2.1",
  date: "08-05-2026",
  prepared: { name: "Jaseem P", role: "Quality Controller", signatureRef: "FSMS-SIG-2026-001", signedDate: "01-04-2026" },
  reviewed: { name: "Mohamed", role: "Quality In Charge", signatureRef: "FSMS-SIG-2026-002", signedDate: "01-04-2026" },
  approved: { name: "Hussam O. Sarhan", role: "Executive Manager", signatureRef: "FSMS-SIG-2026-003", signedDate: "01-04-2026" },
};
...
export const FSMS_MODULE_LINKS = {
  ...
  "6.2": { route: "/haccp-iso/objectives/view", label: "FSMS Objectives" },
  "6.3": { route: "/haccp-iso/change-management/view", label: "Change Management Log" },
  "7.2": { route: "/training", label: "Training Module" },
  "7.3": { route: "/training", label: "Awareness / Training" },
  "7.4": { route: "/haccp-iso/communication-log/view", label: "FSMS Communication Matrix / Log" },
  "7.4-complaints": { route: "/haccp-iso/customer-complaints/view", label: "Customer Complaints" },
  "7.5": { route: "/haccp-iso/document-register/view", label: "Document Master Register" },
  "8.2": { route: "/haccp-iso/sop-ssop", label: "PRPs (SOPs)" },
  "8.2-glass": { route: "/haccp-iso/glass-register/view", label: "Glass & Brittle Plastic Register" },
  ...
  "8.7": { route: "/haccp-iso/calibration/view", label: "Calibration" },
  "8.9.5": { route: "/haccp-iso/real-recall/view", label: "Real Recall" },
  "8.9.5-withdrawal": { route: "/haccp-iso/product-withdrawal/view", label: "Product Withdrawal" },
  "9.1.2": { route: "/haccp-iso/customer-complaints/view", label: "Customer Complaints Analysis" },
  "9.2": { route: "/haccp-iso/internal-audit/view", label: "Internal Audit" },
  "9.3": { route: "/haccp-iso/mrm/view", label: "Management Review (MRM)" },
  "10.2": { route: "/haccp-iso/continual-improvement/view", label: "Continual Improvement Log" },
...
export const FSMS_SECTIONS = [
  /* ─────────── DOCUMENT CONTROL ─────────── */
  {
    ...
    type: "approval",
    body:
      "The signatures below certify that this ISO 22000:2018 manual has been reviewed and accepted; and demonstrate that the signatories are aware of all the requirements contained herein and are committed to ensuring their provision.\n\nElectronic signatures recorded below are deemed equivalent to handwritten signatures per UAE Federal Decree-Law No. 46 of 2021 (Electronic Transactions and Trust Services Law) and ISO 22000:2018 §7.5.2 (creating and updating documented information). Each electronic signature includes the signatory's full name, role, timestamp, and unique signature reference number traceable in the FSMS digital records.",
    bodyAr:
      "التواقيع أدناه تشهد بأن هذا الدليل الخاص بـ ISO 22000:2018 قد تم مراجعته وقبوله، وتُظهر أن الموقّعين على دراية بجميع المتطلبات الواردة فيه وملتزمون بضمان تطبيقها.\n\nالتواقيع الإلكترونية المُسجّلة أدناه تُعتبر مكافئة للتواقيع اليدوية وفقاً للمرسوم بقانون اتحادي رقم (46) لسنة 2021 (المعاملات الإلكترونية وخدمات الثقة) ومتطلبات ISO 22000:2018 §7.5.2 (إنشاء وتحديث المعلومات الموثّقة). يتضمن كل توقيع إلكتروني الاسم الكامل والمنصب والطابع الزمني ورقم مرجع توقيع فريد قابل للتتبع في السجلات الرقمية لـ FSMS.",
    table: {
      headers: ["Role", "Name", "Position", "Electronic Signature", "Date"],
      rows: [
        ["Prepared by",  "Jaseem P",          "Quality Controller", "✓ E-Signed · Ref: FSMS-SIG-2026-001 · IP-logged via FSMS portal", "01-04-2026"],
        ["Reviewed by",  "Mohamed",           "Quality In Charge",  "✓ E-Signed · Ref: FSMS-SIG-2026-002 · IP-logged via FSMS portal", "01-04-2026"],
        ["Approved by",  "Hussam O. Sarhan", "Executive Manager",  "✓ E-Signed · Ref: FSMS-SIG-2026-003 · IP-logged via FSMS portal", "01-04-2026"],
      ],
    },
    tableAr: {
      headers: ["الدور", "الاسم", "المنصب", "التوقيع الإلكتروني", "التاريخ"],
      rows: [
        ["أعدّه",   "جاسم ب",            "مراقب الجودة",      "✓ موقّع إلكترونياً · مرجع: FSMS-SIG-2026-001 · مُسجّل عبر بوابة FSMS", "01-04-2026"],
        ["راجعه",   "محمد",              "مسؤول الجودة",      "✓ موقّع إلكترونياً · مرجع: FSMS-SIG-2026-002 · مُسجّل عبر بوابة FSMS", "01-04-2026"],
        ["اعتمده",  "حسام عمر سرحان",   "المدير التنفيذي",    "✓ موقّع إلكترونياً · مرجع: FSMS-SIG-2026-003 · مُسجّل عبر بوابة FSMS", "01-04-2026"],
      ],
    },
  },
  {
  ...
  },
  {
    ...
    table: {
      ...
      rows: [["TELT-FSMS-MN-01", "2.1", "08-05-2026", "—", "Yes"]],
    },
    tableAr: {
      headers: ["الرقم المرجعي", "رقم المراجعة", "التاريخ", "نسخة غير مضبوطة", "نسخة مضبوطة"],
      rows: [["TELT-FSMS-MN-01", "2.1", "08-05-2026", "—", "نعم"]],
    },
  },
  {
    ...
    table: {
      ...
      rows: [
        ...
        ["Clause 0.1 (Approval)", "Electronic signatures formally captured for Prepared by / Reviewed by / Approved by — replacing the previously blank signature column. References: FSMS-SIG-2026-001/002/003. Compliant with UAE Federal Decree-Law No. 46/2021 (Electronic Transactions) and ISO 22000:2018 §5.1 + §7.5.2.", "2.1", "08-05-2026", "Closure of SGS Stage 2 Audit Major NC #1 (Lead Auditor) — leadership commitment evidence", "FSMS Team", "Top Management (Hussam O. Sarhan)"],
      ],
    },
    tableAr: {
      ...
      rows: [
        ...
        ["البند 0.1 (الاعتماد)", "تم تسجيل التواقيع الإلكترونية رسمياً لـ \"أعدّه\" / \"راجعه\" / \"اعتمده\" — استبدال خانة التوقيع الفارغة سابقاً. مراجع: FSMS-SIG-2026-001/002/003. متوافق مع المرسوم بقانون اتحادي رقم (46) لسنة 2021 (المعاملات الإلكترونية) ومتطلبات ISO 22000:2018 §5.1 + §7.5.2.", "2.1", "08-05-2026", "إغلاق Major NC #1 من تدقيق SGS Stage 2 (المدقق الرئيسي) — دليل التزام القيادة", "فريق FSMS", "الإدارة العليا (حسام عمر سرحان)"],
      ],
    },
  },
  {
  ...
  },
  {
    ...
    type: "table-and-text",
    body:
      "Trans Emirates Livestock Trading L.L.C. is a subsidiary of Livestock Transport & Trading Co. P.S.C. (Al Mawashi), established in the United Arab Emirates in 1982, for the purpose of trading in meat products. Al Mawashi was established in Kuwait in 1973, as a public shareholding company for the purpose of producing, transporting and trading meat products in Kuwait and abroad.\n\nIn the United Arab Emirates, Al Mawashi imports chilled and frozen meat products from approved international sources and supplies them to the local market. UAE operations are limited to receiving, cold storage, cutting / processing, packaging, and distribution. Live-animal slaughtering and feedlot operations are NOT within the current UAE scope.\n\nAl Mawashi operates the main head office in Kuwait, with branches in UAE, Australia and South Africa. The UAE network is composed of: a central processing & distribution warehouse (Al Qusais — opposite Zulaikha Hospital), an administrative office (Deira — opposite Al Qabail), and three retail butcher outlets in Al Barsha, Abu Dhabi, and Al Ain.",
    bodyAr:
      "Trans Emirates Livestock Trading L.L.C. هي شركة تابعة لشركة Livestock Transport & Trading Co. P.S.C. (المواشي)، تأسست في الإمارات العربية المتحدة عام 1982 لغرض تجارة منتجات اللحوم. تأسست المواشي في الكويت عام 1973 كشركة مساهمة عامة لغرض إنتاج منتجات اللحوم ونقلها وتجارتها في الكويت والخارج.\n\nفي الإمارات العربية المتحدة، تستورد المواشي اللحوم المبرّدة والمجمّدة من مصادر دولية معتمدة وتُوزّعها على السوق المحلية. تقتصر العمليات داخل الإمارات على الاستلام، والتخزين البارد، والتقطيع/المعالجة، والتعبئة، والتوزيع. لا تشمل العمليات الحالية في الإمارات الذبح الحي ولا تربية المواشي (Feedlot).\n\nتُدير المواشي مكتبها الرئيسي في الكويت، ولها فروع في الإمارات وأستراليا وجنوب إفريقيا. تتكون شبكة الإمارات من: مستودع مركزي للمعالجة والتوزيع (القصيص — مقابل مستشفى زليخة)، ومكتب إداري (ديرة — مقابل القبائل)، وثلاث ملاحم للبيع: البرشاء، أبوظبي، والعين.",
    table: {
      headers: ["Field", "Value"],
      rows: [
        ["Name", "TRANS EMIRATES LIVESTOCK TRADING LLC"],
        ["Factory / Processing Warehouse Address", "Al Qusais — Opposite Zulaikha Hospital, Near Al Kabeer, Warehouse 2 & 3"],
        ["Head Office Address", "Deira — Opposite Al Qabail"],
        ["Retail Outlets (UAE)", "Al Barsha Butchery · Abu Dhabi Butchery · Al Ain Butchery · Al Qusais Warehouse"],
    ...
    tableAr: {
      ...
      rows: [
        ...
        ["عنوان المصنع / مستودع المعالجة", "القصيص — مقابل مستشفى زليخة، بالقرب من الكبير، المستودع 2 و 3"],
        ["عنوان المكتب الرئيسي", "ديرة — مقابل القبائل"],
        ["منافذ البيع (الإمارات)", "ملحمة البرشاء · ملحمة أبوظبي · ملحمة العين · مستودع القصيص"],
  ...
  },
  {
    ...
    table: {
      ...
      rows: [
        ...
        ["Cybersecurity & ERP/SaaS Dependence", "Dependency on digital systems (ERP, FSMS portal, SaaS apps) for record-keeping, traceability and CCP monitoring", "Loss of records, traceability gaps, audit findings, breach of customer data", "Backup procedures, access control, two-factor authentication, IT security policy, regular vulnerability checks"],
        ["Food Defense (Intentional Contamination)", "Risk of intentional adulteration, sabotage or tampering by employees, contractors or external actors", "Public health crisis, brand damage, product recall, regulatory action", "Food Defense Procedure (SOP 23), restricted access zones, visitor control, employee vetting, surveillance"],
        ["Food Fraud (Economic Adulteration)", "Risk of species substitution, mislabeling, undeclared origin, or fraudulent halal/quality claims along the supply chain", "Loss of consumer trust, halal certification withdrawal, legal action", "Food Fraud Prevention Procedure (SOP 22), DNA testing, supplier audits, COA verification, vulnerability assessment"],
      ],
    },
    tableAr: {
      headers: ["الفئة", "الوصف", "التأثير المحتمل على FSMS", "تدابير التحكم"],
      rows: [
        ...
        ["الأمن السيبراني والاعتماد على الأنظمة الرقمية", "اعتماد على ERP وبوابات FSMS وتطبيقات SaaS لحفظ السجلات والتتبع ومراقبة CCP", "فقدان السجلات، فجوات في التتبع، ملاحظات تدقيق، خرق بيانات العملاء", "إجراءات نسخ احتياطي، تحكم بالوصول، مصادقة ثنائية، سياسة أمن IT، فحوص دورية للثغرات"],
        ["الدفاع الغذائي (التلوث المتعمد)", "خطر الغش أو التخريب أو العبث المتعمد من موظفين أو مقاولين أو جهات خارجية", "أزمة صحة عامة، ضرر للعلامة التجارية، سحب منتج، إجراء تنظيمي", "إجراء الدفاع الغذائي (SOP 23)، مناطق وصول مقيدة، تحكم بالزوار، فحص الموظفين، مراقبة"],
        ["الغش الغذائي (Food Fraud)", "خطر استبدال الأنواع أو الوسم الخاطئ أو الإدعاءات الكاذبة للحلال/الجودة عبر سلسلة التوريد", "فقدان ثقة المستهلك، سحب شهادة الحلال، إجراء قانوني", "إجراء الوقاية من الغش الغذائي (SOP 22)، اختبار DNA، تدقيق الموردين، التحقق من COA، تقييم نقاط الضعف"],
      ],
    },
  },
  {
  ...
  },
  {
    ...
    table: {
      ...
      rows: [
        ["Top Management", "Provide resources, approve food safety policies and objectives, and ensure the FSMS remains effective and aligned with ISO 22000:2018 requirements."],
        ["Unit Head - Operations", "Direct operational activities, ensure process controls are implemented, coordinate cross-functional execution, and support conformity to FSMS, PRP, and HACCP requirements."],
        ["Quality Officer (Food Safety Team Leader)", "Lead HACCP studies and FSMS implementation, coordinate monitoring and verification activities, control documented information, report food safety performance, and ensure follow-up of nonconformities and corrective actions."],
        ["Quality Officer", "Conduct inspections, audits, and product/process verification; monitor compliance with hygiene, GMP, and food safety requirements; maintain records; trend quality data; and support CAPA and continual improvement activities."],
        ["HACCP Team", "Conduct hazard analysis, identify control measures and CCPs/OPRPs, review hazards and validation needs, and support implementation and periodic verification of the HACCP plan."],
        ["Production Operator", "Operate equipment and process products in accordance with approved specifications, SOPs, PRPs, and hygiene requirements; perform in-process checks; complete records; and immediately report deviations affecting food safety or quality."],
        ["Unit Head - Logistics", "Manage warehousing, transport, and distribution controls; ensure storage and delivery conditions are maintained; verify vehicle and warehouse hygiene; and support traceability, stock control, and product protection throughout dispatch activities."],
        ["Commercial Officer", "Coordinate customer requirements, specifications, quotations, and order communication to ensure commercial commitments are translated accurately into operational and food safety requirements, including complaint and feedback follow-up where applicable."],
        ["Warehouse In-Charge", "Control storage conditions, monitor temperature, apply stock rotation, and prevent contamination or product mix-up within storage areas."],
        ["Maintenance Team", "Maintain equipment, utilities, and infrastructure in a condition that supports safe food handling, including preventive maintenance and timely corrective intervention."],
        ["QA/QC Department", "Perform monitoring, inspection, verification, and record control activities to demonstrate conformity of products and processes with established FSMS requirements."],
        ["All Employees", "Follow hygiene rules, SOPs, PRPs, and assigned food safety responsibilities, and promptly report hazards, deviations, or unsafe conditions."],
      ],
    },
    tableAr: {
      headers: ["المنصب", "المسؤوليات"],
      rows: [
        ["الإدارة العليا", "توفير الموارد، اعتماد سياسات وأهداف سلامة الغذاء، وضمان بقاء نظام إدارة سلامة الغذاء فعالاً ومتوافقاً مع متطلبات ISO 22000:2018."],
        ["رئيس وحدة العمليات", "إدارة الأنشطة التشغيلية، ضمان تطبيق ضوابط العمليات، تنسيق التنفيذ بين الأقسام، ودعم المطابقة مع متطلبات FSMS وPRP وHACCP."],
        ["مسؤول الجودة (قائد فريق سلامة الغذاء)", "قيادة دراسات HACCP وتطبيق نظام FSMS، تنسيق أنشطة المراقبة والتحقق، ضبط المعلومات الموثقة، رفع تقارير أداء سلامة الغذاء، وضمان متابعة حالات عدم المطابقة والإجراءات التصحيحية."],
        ["مسؤول الجودة", "تنفيذ التفتيش والتدقيق والتحقق من المنتج والعملية، مراقبة الالتزام بمتطلبات النظافة وGMP وسلامة الغذاء، حفظ السجلات، تحليل اتجاهات الجودة، ودعم إجراءات CAPA والتحسين المستمر."],
        ["فريق HACCP", "إجراء تحليل المخاطر، تحديد تدابير التحكم وCCPs/OPRPs، مراجعة المخاطر واحتياجات التحقق، ودعم تطبيق خطة HACCP والتحقق الدوري منها."],
        ["مشغل الإنتاج", "تشغيل المعدات وتصنيع المنتجات وفق المواصفات المعتمدة وSOPs وPRPs ومتطلبات النظافة، تنفيذ فحوصات أثناء العملية، تعبئة السجلات، والإبلاغ الفوري عن أي انحراف يؤثر على سلامة الغذاء أو الجودة."],
        ["رئيس وحدة اللوجستيات", "إدارة ضوابط التخزين والنقل والتوزيع، ضمان المحافظة على ظروف التخزين والتسليم، التحقق من نظافة المركبات والمستودعات، ودعم التتبع وضبط المخزون وحماية المنتج خلال أنشطة الإرسال."],
        ["المسؤول التجاري", "تنسيق متطلبات العملاء والمواصفات والعروض والطلبات لضمان تحويل الالتزامات التجارية بدقة إلى متطلبات تشغيلية ومتطلبات سلامة غذاء، بما في ذلك متابعة الشكاوى والتغذية الراجعة عند الحاجة."],
        ["مسؤول المستودع", "ضبط ظروف التخزين، مراقبة درجات الحرارة، تطبيق دوران المخزون، ومنع التلوث أو الخلط بين المنتجات داخل مناطق التخزين."],
        ["فريق الصيانة", "المحافظة على المعدات والمرافق والبنية التحتية بحالة تدعم تداول الغذاء بشكل آمن، بما يشمل الصيانة الوقائية والتدخل التصحيحي في الوقت المناسب."],
        ["قسم QA/QC", "تنفيذ أنشطة المراقبة والتفتيش والتحقق وضبط السجلات لإثبات مطابقة المنتجات والعمليات لمتطلبات نظام FSMS المعتمدة."],
        ["جميع الموظفين", "اتباع قواعد النظافة وSOPs وPRPs ومسؤوليات سلامة الغذاء المحددة، والإبلاغ الفوري عن المخاطر أو الانحرافات أو الحالات غير الآمنة."],
      ],
    },
  },
  {
  ...
  },
  {
    ...
    type: "text",
    body:
      "The integrity of FSMS is maintained when changes are planned and implemented by conducting Audits and Management Review Meetings.\n\nTELT LLC considers the following details during planning:\n• The purpose of the changes and their potential consequences\n• The integrity of FSMS\n• The availability of resources\n• The allocation or reallocation of responsibilities and authorities\n\nMandatory 6-step planning procedure (per FSMS-RA-01):\n1. Identify and describe the proposed change — Concerned Department\n2. Evaluate impact on FSMS and food safety — FSMS Team / QA in charge\n3. Approve change prior to implementation — Top Management\n4. Implement change under supervision — Department Head\n5. Update FSMS documents and records — QA / Document Controller\n6. Verify effectiveness of change — FSMS Team\n\nOperationalization:\nThis clause is implemented in the FSMS app via the 🔄 Change Management Log module (link from this clause badge above), which captures every FSMS-impacting change (relocations, team changes, supplier list updates, calibration provider changes, IT system upgrades) with date, reason, impact, approver, implementation date, and verification.\n\nFSMS Clause 6 (Planning) is implemented through the document: FSMS-RA-01 — FSMS Planning and Risk Management Procedure.",
    bodyAr:
      "يتم الحفاظ على سلامة FSMS عند التخطيط وتنفيذ التغييرات من خلال إجراء التدقيقات واجتماعات مراجعة الإدارة.\n\nتنظر TELT LLC في التفاصيل التالية أثناء التخطيط:\n• الغرض من التغييرات وعواقبها المحتملة\n• سلامة FSMS\n• توفر الموارد\n• تخصيص أو إعادة تخصيص المسؤوليات والصلاحيات\n\nإجراء التخطيط الإلزامي من 6 خطوات (وفق FSMS-RA-01):\n1. تحديد ووصف التغيير المقترح — القسم المعني\n2. تقييم الأثر على FSMS وسلامة الغذاء — فريق FSMS / مسؤول QA\n3. اعتماد التغيير قبل التنفيذ — الإدارة العليا\n4. تنفيذ التغيير تحت الإشراف — رئيس القسم\n5. تحديث وثائق وسجلات FSMS — QA / مسؤول ضبط الوثائق\n6. التحقق من فعالية التغيير — فريق FSMS\n\nالتشغيل:\nيتم تطبيق هذا البند في تطبيق FSMS عبر مودول 🔄 سجل إدارة التغييرات (يربط من شارة البند أعلاه)، الذي يلتقط كل تغيير يؤثر على FSMS (انتقال مواقع، تغييرات فريق، تحديث الموردين، تغيير شركة المعايرة، ترقية أنظمة IT) مع التاريخ والسبب والأثر والمعتمد وتاريخ التنفيذ والتحقق.\n\nيتم تطبيق البند 6 (التخطيط) من FSMS من خلال الوثيقة: FSMS-RA-01 — إجراء تخطيط FSMS وإدارة المخاطر.",
  },
  ...
  /* ─────────── CLAUSE 7 ─────────── */
  {
    ...
    type: "text",
    body:
      "The organization ensures that adequate resources are provided to establish, implement, maintain, and continually improve the FSMS.\n\nResources include:\n• Adequate manpower with defined responsibilities\n• Suitable infrastructure (cold storage, chillers, cutting and packaging equipment)\n• Suitable work environment (temperature control, hygiene conditions)\n• Monitoring and measuring equipment with proper calibration\n• Maintenance of equipment and facilities\n\nThe details are maintained in separate procedures and records:\n• Maintenance Plan\n• Calibration Records\n• Infrastructure Management Records\n\n7.1.5 Externally Developed Elements of the FSMS:\nTELT uses externally developed elements within its FSMS and ensures these elements are:\n• Developed in conformance with the requirements of this document\n• Applicable to the sites, processes and products of the organization\n• Specifically adapted by the Food Safety Team for TELT's conditions\n• Implemented, maintained, updated and retained as documented information per FSMS requirements\n\nApproved external sources include:\n• Codex Alimentarius — CAC/RCP 1-1969 (General Principles of Food Hygiene)\n• ISO/TS 22002-1:2009 — Prerequisite Programmes (PRPs) for food manufacturing\n• Dubai Municipality Food Safety Department Guidelines (Dubai Food Code)\n• ADAFSA (Abu Dhabi Agriculture & Food Safety Authority) guidelines\n• UAE.S 2055-1 (Halal Products Requirements)\n• SAI Global HACCP Templates\n• WHO and FAO food safety guidelines",
    bodyAr:
      "تضمن المنظمة توفير الموارد الكافية لإنشاء وتنفيذ وصيانة وتحسين FSMS باستمرار.\n\nتشمل الموارد:\n• قوّة عاملة كافية بمسؤوليات محددة\n• بنية تحتية مناسبة (مخازن باردة، ثلاجات، معدات تقطيع وتعبئة)\n• بيئة عمل مناسبة (التحكم في درجة الحرارة، ظروف صحية)\n• أجهزة المراقبة والقياس ذات المعايرة السليمة\n• صيانة المعدات والمرافق\n\nيتم الاحتفاظ بالتفاصيل في إجراءات وسجلات منفصلة:\n• خطة الصيانة\n• سجلات المعايرة\n• سجلات إدارة البنية التحتية\n\n7.1.5 العناصر المُطوّرة خارجياً للنظام:\nتستخدم TELT عناصر مُطوّرة خارجياً ضمن نظام FSMS، وتضمن أنها:\n• مُطوّرة بما يتوافق مع متطلبات هذه الوثيقة\n• قابلة للتطبيق على المواقع والعمليات والمنتجات الخاصة بالمنظمة\n• مُكيّفة خصيصاً من قبل فريق سلامة الغذاء لظروف TELT\n• مُطبّقة ومُحدّثة وموثّقة وفق متطلبات FSMS\n\nالمصادر الخارجية المعتمدة تشمل:\n• Codex Alimentarius — CAC/RCP 1-1969 (المبادئ العامة لصحة الأغذية)\n• ISO/TS 22002-1:2009 — Prerequisite Programmes (PRPs) for food manufacturing\n• إرشادات قسم سلامة الأغذية في بلدية دبي (Dubai Municipality Food Code)\n• إرشادات هيئة أبوظبي للزراعة والسلامة الغذائية (ADAFSA)\n• معيار UAE.S 2055-1 (متطلبات منتجات الحلال)\n• قوالب SAI Global لـ HACCP\n• إرشادات منظمة الصحة العالمية (WHO) ومنظمة الأغذية والزراعة (FAO)",
  },
  {
  ...
  },
  {
    ...
    type: "text",
    body:
      "TELT LLC takes action(s) to prevent potentially unsafe products from entering the process unless it can demonstrate that:\n• The food safety hazard(s) are reduced to defined acceptable levels;\n• The hazards will be reduced to acceptable levels prior to entering the process;\n• The food still meets defined acceptable levels despite the non-conformity.\n\nProducts identified as potentially unsafe are retained under control until evaluated and disposition determined. If unsafe products leave TELT LLC, relevant interested parties are notified and a withdrawal/recall is initiated.\n\nEvaluation for Release: Each lot affected by non-conformity is evaluated. Products affected by failure to remain within critical limits at CCPs are not released.\n\nDisposition of Non-conforming Products:\n• Reprocessed or further processed (within or outside the organization) to reduce hazard to acceptable levels; OR\n• Redirected for other use if food safety is not affected; OR\n• Destroyed and/or disposed as waste\n\n8.9.5 Withdrawal/Recall:\nTELT LLC ensures timely withdrawal/recall of lots identified as potentially unsafe by appointing competent persons with the authority to initiate and carry out the withdrawal/recall.\n\nTELT LLC distinguishes two separate levels of removal, because the required response differs:\n• Withdrawal — removal of affected product from the distribution chain where the product has NOT reached the end consumer (company warehouse, vehicles in transit, branch back-store, display shelf, wholesale customers). It is an internal supply-chain action: stock is held and quarantined at every location, and public consumer notification is not required.\n• Recall — retrieval of affected product that HAS reached the end consumer. It requires authority notification and, depending on the class, a public consumer notice.\n\nA withdrawal is escalated to a recall immediately whenever any quantity of the affected batch was sold to or consumed by an end consumer, whenever unaccounted quantity cannot exclude consumer sale, whenever a consumer illness or complaint linked to the batch is reported, or whenever an authority instructs a recall.\n\nThree FSMS modules are maintained:\n• 🔄 Mock Recall / Traceability Drill — periodic drills verifying that the traceability and removal system works (effectiveness verification). See SOP 10.\n• 📦 Product Withdrawal — actual withdrawal events with Level A/B/C, distribution reach, a per-location stock-hold matrix (dispatched / held / returned / sold), quarantine controls, time-to-secure and Stock Secured Rate KPIs, disposition, cost and CAPA, plus an explicit escalation path to recall. See SOP 30.\n• 🚨 Real Product Recall — actual recall events with Class I/II/III, authority notification (DM/ADAFSA/MoCCAE/MoH) with 24-hour SLA tracking, recovery tracking, disposition, cost analysis and CAPA. See SOP 9.\n\nEffectiveness is verified using Mock Withdrawal/Recall exercises and, for real events, by the Stock Secured Rate (target 100%), the time to secure stock (target ≤ 24 h for Level A) and the recovery rate. Both withdrawal and recall events are reported to top management as input for management review.",
    bodyAr:
      "تتخذ TELT LLC إجراءات لمنع المنتجات غير الآمنة المحتملة من دخول العملية ما لم يمكنها إثبات أن:\n• مخاطر سلامة الغذاء تم تخفيضها إلى المستويات المقبولة المحددة؛\n• سيتم تخفيض المخاطر إلى المستويات المقبولة قبل دخول العملية؛\n• لا يزال الغذاء يلبي المستويات المقبولة المحددة رغم عدم المطابقة.\n\nيتم الاحتفاظ بالمنتجات المحددة على أنها غير آمنة محتملة تحت السيطرة حتى يتم تقييمها وتحديد التصرف. إذا خرجت منتجات غير آمنة من TELT LLC، يتم إبلاغ الأطراف المعنية ذات الصلة وبدء عملية سحب/استرجاع.\n\nالتقييم للإفراج: يتم تقييم كل دفعة متأثرة بعدم المطابقة. لا يتم الإفراج عن المنتجات المتأثرة بفشل البقاء ضمن الحدود الحرجة في CCPs.\n\nالتصرف في المنتجات غير المطابقة:\n• إعادة المعالجة أو المعالجة الإضافية (داخل أو خارج المنظمة) لتقليل المخاطر إلى مستويات مقبولة؛ أو\n• إعادة التوجيه لاستخدام آخر إذا لم تتأثر سلامة الغذاء؛ أو\n• الإتلاف و/أو التخلص كنفايات\n\n8.9.5 السحب/الاستدعاء:\nتضمن TELT LLC السحب/الاستدعاء في الوقت المناسب للدفعات المحددة على أنها غير آمنة محتملة من خلال تعيين أشخاص أكفّاء بصلاحية بدء وتنفيذ السحب/الاستدعاء.\n\nتفرّق TELT LLC بين مستويين منفصلين للإزالة، لأن الاستجابة المطلوبة تختلف بينهما:\n• السحب (Withdrawal) — إزالة المنتج المتأثر من سلسلة التوزيع حيث لم يصل المنتج إلى المستهلك النهائي (مستودع الشركة، والمركبات أثناء النقل، والمخزن الخلفي للفرع، ورف العرض، وعملاء الجملة). وهو إجراء داخلي ضمن سلسلة الإمداد: يُحجَز المخزون ويُعزَل في كل موقع، ولا يستلزم إعلاناً عاماً للمستهلكين.\n• الاستدعاء (Recall) — استرجاع المنتج المتأثر الذي وصل بالفعل إلى المستهلك النهائي. ويستلزم إخطار السلطات، وبحسب التصنيف، إصدار إعلان عام للمستهلكين.\n\nيُصعَّد السحب إلى استدعاء فوراً عند بيع أو استهلاك أي كمية من الدفعة المتأثرة من قِبَل مستهلك نهائي، أو عند وجود كمية غير محتسَبة لا يمكن معها استبعاد البيع للمستهلك، أو عند الإبلاغ عن مرض أو شكوى مستهلك مرتبطة بالدفعة، أو عند توجيه جهة رقابية بإجراء استدعاء.\n\nيتم الاحتفاظ بثلاث وحدات في FSMS:\n• 🔄 Mock Recall / تمرين التتبع — تمارين دورية للتحقق من عمل نظام التتبع والإزالة (التحقق من الفعالية). راجع SOP 10.\n• 📦 سحب المنتج (Product Withdrawal) — حالات السحب الفعلية بمستويات A/B/C، ومدى الانتشار، ومصفوفة حجز المخزون لكل موقع (المُرسَلة / المحجوزة / المُعادة / المباعة)، وضوابط الحجر، ومؤشرات زمن التأمين ونسبة تأمين المخزون، والتصرف، والتكلفة، وCAPA، إضافةً إلى مسار تصعيد صريح إلى الاستدعاء. راجع SOP 30.\n• 🚨 الاستدعاء الفعلي (Real Product Recall) — حالات الاستدعاء الفعلية بتصنيف Class I/II/III، وإخطار السلطات (بلدية دبي/أدافسا/MoCCAE/الصحة) مع تتبع مهلة الـ 24 ساعة، وتتبع الاسترداد، وتحديد التصرف، وتحليل التكلفة، وCAPA. راجع SOP 9.\n\nيتم التحقق من الفعالية باستخدام تمارين السحب الوهمية، وفي الحالات الفعلية عبر نسبة تأمين المخزون (الهدف 100%) وزمن تأمين المخزون (الهدف ≤ 24 ساعة للمستوى A) ونسبة الاسترداد. وتُبلَّغ حالات السحب والاستدعاء للإدارة العليا كمدخل لمراجعة الإدارة.",
  },
