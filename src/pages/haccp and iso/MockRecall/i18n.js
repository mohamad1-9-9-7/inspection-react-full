...
export const STRINGS = {
  ar: {
    ...
    prodDefrostTitle: "سجل إذابة التجميد (إنتاج)",
    prodDefrostHint: "اختر سجل ديفروستينج — عند الاختيار يُعرض ملف العرض الأصلي",
    prodCuttingTitle: "سجل التقطيع المباشر (إنتاج)",
    prodCuttingHint: "اختر سجل أونلاين كاتينج — عند الاختيار يُعرض ملف العرض الأصلي",
    prodDriedTitle: "سجل تصنيع اللحم المجفف (إنتاج)",
    prodDriedHint: "اختر سجل اللحم المجفف — عند الاختيار يُعرض ملف العرض الأصلي",
    popupProdDefrost: "❄️ سجل إذابة التجميد — ملف العرض",
    popupProdCutting: "✂️ سجل التقطيع المباشر — ملف العرض",
    popupProdDried: "🥓 سجل اللحم المجفف — ملف العرض",
  ...
  en: {
    ...
    viewFile: "📄 View File",
    /* ===== 🆕 Production reports (view only) ===== */
    prodDefrostTitle: "Defrosting Record (Production)",
    prodDefrostHint: "Pick a defrosting record — the source view file opens on selection",
    prodCuttingTitle: "On-Line Cutting Record (Production)",
    prodCuttingHint: "Pick an online cutting record — the source view file opens on selection",
    prodDriedTitle: "Dried Meat Process (Production)",
    prodDriedHint: "Pick a dried meat record — the source view file opens on selection",
    popupProdDefrost: "❄️ Defrosting Record — View File",
    popupProdCutting: "✂️ On-Line Cutting Record — View File",
    popupProdDried: "🥓 Dried Meat Process — View File",
