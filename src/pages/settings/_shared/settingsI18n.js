...
export const ST = {
  ...
  priceMonthly:  { en: "Monthly price", ar: "السعر الشهري" },
  setupFee:      { en: "Setup fee (one-time)", ar: "رسوم التأسيس (لمرة واحدة)" },
  setupFeeHint:  { en: "One-time onboarding cost, charged once at signup.", ar: "تكلفة تأسيس تُدفع لمرة واحدة عند الاشتراك." },
  ...
  inactiveOnly:  { en: "Inactive only", ar: "غير المفعّلة فقط" },
  totalPlans:    { en: "Total plans", ar: "إجمالي الخطط" },
  activePlans:   { en: "Active plans", ar: "الخطط المفعّلة" },
  assignedCompanies: { en: "Assigned companies", ar: "الشركات المُسندة" },
  mrrEstimate:   { en: "MRR estimate", ar: "الإيراد الشهري التقديري" },
  loadingDots:   { en: "Loading…", ar: "جارٍ التحميل…" },
  noPlansMatch:  { en: "No plans match the current filters.", ar: "لا توجد خطط مطابقة للفلاتر الحالية." },

  // ── Billing overview tab ──
  boEyebrow:     { en: "Billing Command Center", ar: "مركز إدارة الفوترة" },
  boTitle:       { en: "Billing & Subscription Overview", ar: "لوحة الفوترة والاشتراكات" },
  boSubtitle:    { en: "Executive view for plans, companies, subscription health, invoices, and renewal risk.", ar: "ملخص تنفيذي للخطط، الشركات، الاشتراك، الفواتير، والتنبيهات القريبة." },
  refresh:       { en: "Refresh", ar: "تحديث" },
  loadingData:   { en: "Loading billing data…", ar: "جارٍ تحميل بيانات الفوترة…" },
  boActiveCompanies: { en: "Active companies", ar: "الشركات المفعّلة" },
  boTrialSuffix: { en: "trial", ar: "تجريبي" },
  boMrr:         { en: "MRR estimate", ar: "الإيراد الشهري التقديري" },
  boMrrSub:      { en: "from active assigned plans", ar: "من الخطط المفعّلة المُسندة" },
  boRenewalRisk: { en: "Renewal risk", ar: "مخاطر التجديد" },
  boOverdueSuffix: { en: "overdue", ar: "متأخر" },
  boInvoicesIssued: { en: "Invoices issued", ar: "الفواتير الصادرة" },
  boPlanUtil:    { en: "Plan utilization", ar: "استخدام الخطط" },
  boNoPlansYet:  { en: "No plans yet.", ar: "لا توجد خطط بعد." },
  boActiveTotal: { en: "active /", ar: "مفعّلة /" },
  boTotalCompanies: { en: "total companies", ar: "إجمالي الشركات" },
  boRenewalWatch: { en: "Renewal watch", ar: "مراقبة التجديد" },
  boNoPlan:      { en: "No plan", ar: "بلا خطة" },
  boNoEndDate:   { en: "No end date", ar: "بلا تاريخ انتهاء" },
  boDOverdue:    { en: "d overdue", ar: " يوم تأخير" },
  boDLeft:       { en: "d left", ar: " يوم متبقٍ" },
  boNoRenewals:  { en: "No renewals due in the next 14 days.", ar: "لا تجديدات مستحقة خلال الـ 14 يوماً القادمة." },
  boDataGaps:    { en: "Billing data gaps", ar: "نواقص بيانات الفوترة" },
  boGapNoPlan:   { en: "Companies without a plan", ar: "شركات بلا خطة" },
  boGapNoEmail:  { en: "Companies without contact email", ar: "شركات بلا بريد تواصل" },
  boGapNoEnd:    { en: "Companies without end date", ar: "شركات بلا تاريخ انتهاء" },
  boGapInactive: { en: "Inactive plans", ar: "خطط غير مفعّلة" },
  ...
  noCompaniesMatch: { en: "No companies match the current filters.", ar: "لا توجد شركات مطابقة للفلاتر الحالية." },
  ...
  disableCompanyQ: { en: "Disable this company?", ar: "تعطيل هذه الشركة؟" },
  disableCompanyD: { en: "Nobody in this company can sign in, and anyone signed in now is signed out. Only you (super-admin) can still enter it. Its data and accounts stay exactly as they are.", ar: "لن يستطيع أي أحد من هذه الشركة الدخول، ومن هو داخل الآن سيُخرج. أنت فقط (السوبر أدمن) تستطيع الدخول إليها. بياناتها وحساباتها تبقى كما هي." },
  enableCompanyQ:  { en: "Re-enable this company?", ar: "إعادة تفعيل هذه الشركة؟" },
  enableCompanyD:  { en: "Its accounts can sign in again, with the same plan, dates and data as before.", ar: "ستتمكن حساباتها من الدخول مجدداً بنفس الخطة والتواريخ والبيانات السابقة." },
  disableCompany:  { en: "Disable", ar: "تعطيل" },
  enableCompany:   { en: "Re-enable", ar: "إعادة التفعيل" },
  companyDisabled: { en: "Company disabled", ar: "تم تعطيل الشركة" },
  companyEnabled:  { en: "Company re-enabled", ar: "تمت إعادة تفعيل الشركة" },
  failToggle:      { en: "Could not change the company", ar: "تعذّر تغيير حالة الشركة" },
  primaryCompany:  { en: "The primary company cannot be disabled", ar: "لا يمكن تعطيل الشركة الرئيسية" },
  stDisabled:      { en: "Disabled", ar: "معطّلة" },
  ...
  amGroupNone:      { en: "No grouping",         ar: "بدون تجميع" },
  amGroupBranch:    { en: "Branch (automatic)",  ar: "الفرع (تلقائي)" },
  amGroupCustom:    { en: "My groups",           ar: "مجموعاتي" },
  amSortBy:         { en: "Sort",                ar: "ترتيب" },
  amSortName:       { en: "Name",                ar: "الاسم" },
  amSortLogin:      { en: "Last login",          ar: "آخر دخول" },
  amSortRole:       { en: "Role",                ar: "الصلاحية" },
  amManageGroups:   { en: "Manage groups",       ar: "إدارة المجموعات" },
  amGroupsTitle:    { en: "Account groups",      ar: "مجموعات الحسابات" },
  amGroupsHint:     { en: "Create a group, then tick the accounts that belong to it. An account sits in one group at a time.", ar: "أنشئ مجموعة ثم أشّر على الحسابات التي تتبعها. الحساب يتبع مجموعة واحدة فقط." },
  amGroupName:      { en: "Group name",          ar: "اسم المجموعة" },
  amGroupNameAr:    { en: "Arabic name",         ar: "الاسم بالعربية" },
  amGroupAdd:       { en: "Add group",           ar: "أضف مجموعة" },
  amGroupDelete:    { en: "Delete group",        ar: "احذف المجموعة" },
  amGroupMembers:   { en: "accounts",            ar: "حساب" },
  amGroupUngrouped: { en: "Ungrouped",           ar: "بلا مجموعة" },
  amGroupNoBranch:  { en: "No branch assigned",  ar: "بلا فرع" },
  amGroupAllAccess: { en: "Full access / Admin", ar: "صلاحية كاملة / مدير" },
  amGroupsSaved:    { en: "Groups saved",        ar: "تم حفظ المجموعات" },
  amGroupsSaveErr:  { en: "Could not save the groups", ar: "تعذّر حفظ المجموعات" },
  amGroupsOffline:  { en: "Showing a cached copy — the server did not answer.", ar: "معروض من نسخة محفوظة — السيرفر لم يستجب." },
  amGroupEmpty:     { en: "No accounts in this group yet.", ar: "لا حسابات في هذه المجموعة بعد." },
  amBranchMemberships: { en: "memberships", ar: "انتساب" },
  amGroupRename:      { en: "Rename / restyle",   ar: "تعديل الاسم واللون" },
  amGroupRenameDone:  { en: "Done",               ar: "تم" },
  amGroupNeedsName:   { en: "A group needs a name.", ar: "لازم اسم للمجموعة." },
  amGroupDupName:     { en: "A group with this name already exists.", ar: "في مجموعة بنفس الاسم." },
  amGroupUnsaved:     { en: "unsaved",            ar: "غير محفوظ" },
  amGroupDiscardAsk:  { en: "Close without saving? The changes will be lost.", ar: "إغلاق بدون حفظ؟ ستضيع التعديلات." },
  amGroupKeepEditing: { en: "Keep editing",       ar: "متابعة التعديل" },
  amGroupDiscard:     { en: "Discard",            ar: "تجاهل" },
  amGroupFindPerson:  { en: "Search an account…", ar: "ابحث عن حساب…" },
  amGroupScopeAll:    { en: "All accounts",       ar: "كل الحسابات" },
  amGroupScopeFree:   { en: "Ungrouped only",     ar: "بلا مجموعة فقط" },
  amGroupScopeMine:   { en: "Members only",       ar: "أعضاء المجموعة فقط" },
  amGroupAnyBranch:   { en: "Any branch",         ar: "كل الفروع" },
  amGroupAddShown:    { en: "Add all shown",      ar: "ضمّ كل الظاهرين" },
  amGroupRemoveShown: { en: "Remove all shown",   ar: "أخرج كل الظاهرين" },
  amGroupMoved:       { en: "Moved from another group", ar: "نُقلوا من مجموعة أخرى" },
  amGroupGhosts:      { en: "Members whose account no longer exists", ar: "أعضاء لم يعد لهم حساب" },
  amGroupGhostsClean: { en: "Clean up",           ar: "تنظيف" },
