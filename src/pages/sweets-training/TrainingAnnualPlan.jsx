...
const SESSION_TYPE = "sweets_training_session";
...
/* ===================== Modules & Branches ===================== */
const MODULES = SWEETS_MODULES;

/* ✅ مناطق مصنع الحلويات */
const BRANCHES = SWEETS_AREAS.map((a) => ({
  key: a.labelEn,
  label: a.labelEn,
  icon: a.icon,
...
/* ===================== Default Plan ===================== */
const DEFAULT_MONTHLY_FOCUS = SWEETS_MONTHLY_FOCUS;
