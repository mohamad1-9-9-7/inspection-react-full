...
export const QUIZ_BANK = {
  ...
  "OHS: Manual Handling": [
    ...
    { difficulty: "Easy", q_en: "Before using a trolley you must:", q_ar: "قبل استخدام العربة (الترولي) يجب:", options_en: ["Use it straight away", "Check wheels, parts and brakes are in good condition", "Only check the colour"], options_ar: ["استخدامها فوراً", "فحص العجلات والأجزاء والفرامل", "فحص اللون فقط"], correct: 1 },
    { difficulty: "Easy", q_en: "A trolley with a seized or broken wheel should be:", q_ar: "العربة ذات العجلة العالقة أو المكسورة يجب:", options_en: ["Used carefully", "Tagged OUT OF SERVICE and reported for maintenance", "Pushed by two people"], options_ar: ["استخدامها بحذر", "وضع بطاقة \"خارج الخدمة\" عليها وطلب صيانة", "دفعها بشخصين"], correct: 1 },
    { difficulty: "Medium", q_en: "When loading a trolley, heavy items should be placed:", q_ar: "عند تحميل العربة، توضع الأصناف الثقيلة:", options_en: ["On the top deck", "On the bottom deck, evenly distributed", "Hanging over the edge"], options_ar: ["في الرف العلوي", "في الرف السفلي وموزّعة بالتساوي", "خارج حدود السطح"], correct: 1 },
    { difficulty: "Medium", q_en: "Trolley brakes must be engaged:", q_ar: "يجب تفعيل فرامل العربة:", options_en: ["Only at the end of the shift", "Whenever stationary — loading, unloading, or on any slope", "Never, they slow work down"], options_ar: ["في نهاية الوردية فقط", "عند أي توقف — تحميل أو تفريغ أو على أي منحدر", "أبداً لأنها تبطئ العمل"], correct: 1 },
    { difficulty: "Hard", q_en: "When moving a loaded trolley DOWN a ramp you should:", q_ar: "عند نزول العربة المحمّلة على منحدر يجب:", options_en: ["Let it run ahead and follow it", "Stay on the uphill side and control the descent", "Turn it sideways and slide"], options_ar: ["تركها تسبقك ثم اللحاق بها", "الوقوف في الجهة العليا والتحكم بالنزول", "قلبها جانبياً وتزحيقها"], correct: 1 },
  ],
  ...
  "OHS: Loading & Unloading": [
    /* ===== Easy / سهل ===== */
    { difficulty: "Easy", q_en: "Before any handling starts, the vehicle must be:", q_ar: "قبل بدء أي مناولة يجب أن تكون المركبة:", options_en: ["Left with the engine running for a quick departure","Engine off, parking brake on, wheel chocks fitted, key held by the supervisor","Parked wherever is convenient"], options_ar: ["محركها يعمل استعداداً للمغادرة السريعة","المحرك مطفأ، فرامل الوقوف مفعّلة، الأوتاد مركّبة، والمفتاح لدى المشرف","متوقفة في أي مكان مناسب"], correct: 1 },
    { difficulty: "Easy", q_en: "To get down from the truck bed you must:", q_ar: "للنزول من صندوق الشاحنة يجب:", options_en: ["Jump down carefully","Use the fixed steps or an approved access platform","Climb down over the stacked load"], options_ar: ["القفز بحذر","استخدام السلالم الثابتة أو منصة وصول معتمدة","النزول فوق الأحمال المستيفة"], correct: 1 },
    { difficulty: "Easy", q_en: "A high-visibility vest in the loading bay is:", q_ar: "السترة العاكسة في منطقة التحميل:", options_en: ["Only for forklift drivers","Mandatory for everyone entering the bay, visitors and drivers included","Optional during the day"], options_ar: ["لسائقي الرافعات فقط","إلزامية لكل من يدخل المنطقة بما فيهم الزوار والسائقون","اختيارية أثناء النهار"], correct: 1 },
    { difficulty: "Easy", q_en: "The site speed limit in the yard is:", q_ar: "السرعة القصوى داخل ساحة الموقع هي:", options_en: ["10 km/h","30 km/h","There is no posted limit"], options_ar: ["10 كم/س","30 كم/س","لا توجد سرعة محددة"], correct: 0 },
    { difficulty: "Easy", q_en: "The maximum single-person lifting weight in the loading bay is:", q_ar: "الحد الأقصى للرفع اليدوي للفرد الواحد في منطقة التحميل هو:", options_en: ["40 kg","25 kg — above that a two-person lift is required","There is no limit"], options_ar: ["40 كجم","25 كجم — وما فوقها يتطلب رفعاً ثنائياً","لا يوجد حد"], correct: 1 },
    /* ===== Medium / متوسط ===== */
    { difficulty: "Medium", q_en: "Who may stand in the exclusion zone behind a reversing vehicle?", q_ar: "من يُسمح له بالوقوف في منطقة الاستبعاد خلف مركبة ترجع للخلف؟", options_en: ["The banksman only","No one","Anyone wearing a high-visibility vest"], options_ar: ["المراقب فقط","لا أحد","أي شخص يرتدي سترة عاكسة"], correct: 1 },
    { difficulty: "Medium", q_en: "A banksman is required:", q_ar: "وجود المراقب (Banksman) مطلوب:", options_en: ["Only at night","For every reversing manoeuvre","Only when the driver asks for one"], options_ar: ["ليلاً فقط","عند كل مناورة رجوع للخلف","فقط إذا طلبه السائق"], correct: 1 },
    { difficulty: "Medium", q_en: "The minimum lighting level in the loading area is:", q_ar: "الحد الأدنى للإضاءة في منطقة التحميل هو:", options_en: ["50 lux","200 lux, verified by a documented monthly check","Any light level is acceptable"], options_ar: ["50 لكس","200 لكس مع فحص شهري موثّق","أي مستوى إضاءة مقبول"], correct: 1 },
    { difficulty: "Medium", q_en: "A damaged securement strap must be:", q_ar: "حزام التثبيت التالف يجب:", options_en: ["Used only for light loads","Withdrawn from service immediately","Repaired with tape and reused"], options_ar: ["استخدامه للأحمال الخفيفة فقط","سحبه من الخدمة فوراً","إصلاحه بشريط لاصق وإعادة استخدامه"], correct: 1 },
    { difficulty: "Medium", q_en: "If no trolley or pallet truck is available, you should:", q_ar: "إذا لم تتوفر عربة أو مكبس بالات، يجب:", options_en: ["Lift the load by hand to save time","Wait — an unavailable aid is never a reason to lift by hand","Drag the load across the floor"], options_ar: ["رفع الحمولة يدوياً توفيراً للوقت","الانتظار — تعطّل الوسيلة ليس مبرراً للرفع اليدوي","سحب الحمولة على الأرض"], correct: 1 },
    /* ===== Hard / صعب ===== */
    { difficulty: "Hard", q_en: "If the driver loses sight of the banksman during reversing, the driver must:", q_ar: "إذا غاب المراقب عن نظر السائق أثناء الرجوع للخلف، يجب على السائق:", options_en: ["Continue slowly","Stop immediately","Sound the horn and carry on"], options_ar: ["المتابعة ببطء","التوقف فوراً","إطلاق البوق والمتابعة"], correct: 1 },
    { difficulty: "Hard", q_en: "The pre-departure load-securement checklist is signed by:", q_ar: "قائمة فحص تثبيت الحمولة قبل المغادرة يوقّعها:", options_en: ["The driver only","The driver and the supervisor","Nobody — it is an informal check"], options_ar: ["السائق فقط","السائق والمشرف معاً","لا أحد — فحص غير رسمي"], correct: 1 },
    { difficulty: "Hard", q_en: "The wheel chocks are removed and the key returned only after:", q_ar: "لا تُرفع أوتاد العجلات ولا يُعاد المفتاح إلا بعد:", options_en: ["The first pallet is loaded","The doors are closed and everyone is clear of the manoeuvring area","The driver signs the delivery note"], options_ar: ["تحميل أول بالة","إغلاق الأبواب وخروج الجميع من منطقة المناورة","توقيع السائق على إذن التسليم"], correct: 1 },
    { difficulty: "Hard", q_en: "During heavy rain or on an iced floor, the shift supervisor:", q_ar: "عند الأمطار الغزيرة أو الأرضية المتجمّدة، مشرف المناوبة:", options_en: ["Must continue in order to keep the schedule","Has the authority to suspend the operation until it is safe","Must obtain head-office approval first"], options_ar: ["يجب أن يستمر للحفاظ على الجدول","له صلاحية تعليق العملية حتى تصبح آمنة","يجب أن يأخذ موافقة الإدارة أولاً"], correct: 1 },
    { difficulty: "Hard", q_en: "A near-miss in the loading bay where nobody was injured must be:", q_ar: "شبه الحادث في منطقة التحميل الذي لم يُصب فيه أحد يجب:", options_en: ["Ignored, since there was no injury","Reported and investigated the same day like any other incident","Mentioned verbally to the supervisor only"], options_ar: ["تجاهله لعدم وجود إصابة","الإبلاغ عنه والتحقيق فيه في اليوم نفسه كأي حادث","ذكره شفهياً للمشرف فقط"], correct: 1 },
  ],
  ...
  "OHS: First Aid & Incident Reporting": [
    ...
    { difficulty: "Easy", q_en: "In the UAE, the number for an AMBULANCE is:", q_ar: "في الإمارات، رقم الإسعاف هو:", options_en: ["999", "998", "997"], options_ar: ["999", "998", "997"], correct: 1 },
    { difficulty: "Easy", q_en: "The first letter of the DRABC primary survey stands for:", q_ar: "الحرف الأول في الفحص الأولي DRABC يعني:", options_en: ["Dressing", "Danger — make the scene safe first", "Doctor"], options_ar: ["الضماد", "الخطر — تأمين المكان أولاً", "الطبيب"], correct: 1 },
    { difficulty: "Easy", q_en: "To check if a casualty responds you should:", q_ar: "للتحقق من استجابة المصاب يجب:", options_en: ["Shake them hard", "Touch and talk — never shake", "Pour water on them"], options_ar: ["هزّه بقوة", "لمسه ومخاطبته — دون هزّ أبداً", "سكب ماء عليه"], correct: 1 },
    { difficulty: "Medium", q_en: "Checking for normal breathing should take no longer than:", q_ar: "فحص التنفس الطبيعي يجب ألا يستغرق أكثر من:", options_en: ["10 seconds", "2 minutes", "30 seconds"], options_ar: ["10 ثوانٍ", "دقيقتين", "30 ثانية"], correct: 0 },
    { difficulty: "Medium", q_en: "The adult CPR cycle is:", q_ar: "دورة الإنعاش القلبي للبالغين هي:", options_en: ["15 compressions : 1 breath", "30 compressions : 2 rescue breaths", "10 compressions : 5 breaths"], options_ar: ["15 ضغطة : نفَس واحد", "30 ضغطة : نفَسان إنقاذيان", "10 ضغطات : 5 أنفاس"], correct: 1 },
    { difficulty: "Medium", q_en: "For a choking casualty who is coughing forcefully you should:", q_ar: "للمختنق الذي يسعل بقوة يجب:", options_en: ["Slap the back immediately", "Encourage them to keep coughing", "Give abdominal thrusts at once"], options_ar: ["ضرب ظهره فوراً", "تشجيعه على مواصلة السعال", "إعطاء دفعات بطنية فوراً"], correct: 1 },
    { difficulty: "Medium", q_en: "A casualty in shock should be given:", q_ar: "المصاب بالصدمة يجب أن يُعطى:", options_en: ["Hot tea and food", "No food or drink — lay down, raise the legs, keep warm", "A cigarette to calm down"], options_ar: ["شاي ساخن وطعام", "لا طعام ولا شراب — إضجاعه ورفع ساقيه وتدفئته", "سيجارة ليهدأ"], correct: 1 },
    { difficulty: "Hard", q_en: "The correct CPR compression rate is:", q_ar: "المعدل الصحيح لضغطات الإنعاش:", options_en: ["40–60 per minute", "100–120 per minute", "As fast as possible"], options_ar: ["40–60 في الدقيقة", "100–120 في الدقيقة", "بأقصى سرعة ممكنة"], correct: 1 },
    { difficulty: "Hard", q_en: "A severed body part being sent to hospital must be:", q_ar: "الجزء المبتور المُرسل للمستشفى يجب أن:", options_en: ["Placed directly on ice", "Bagged and sealed, then that bag placed in ice water — never touching ice directly", "Washed then frozen"], options_ar: ["يوضع على الثلج مباشرة", "يوضع في كيس محكم ثم يوضع الكيس في ماء مثلج — دون ملامسة الثلج مباشرة", "يُغسل ثم يُجمّد"], correct: 1 },
    { difficulty: "Hard", q_en: "You should stop CPR when:", q_ar: "يجب التوقف عن الإنعاش عند:", options_en: ["After 5 minutes regardless", "Professionals take over, normal breathing returns, the area becomes unsafe, or you are exhausted", "When the casualty looks pale"], options_ar: ["بعد 5 دقائق مهما كان", "تسلّم المختصين، أو عودة التنفس الطبيعي، أو أن تصبح المنطقة غير آمنة، أو الإرهاق التام", "عندما يبدو المصاب شاحباً"], correct: 1 },
    { difficulty: "Hard", q_en: "After giving abdominal thrusts to a choking casualty you must:", q_ar: "بعد إعطاء دفعات بطنية لمختنق يجب:", options_en: ["Send them back to work", "Have them examined by a doctor — thrusts can cause internal injury", "Give them water and wait"], options_ar: ["إعادته للعمل", "عرضه على طبيب — الدفعات قد تسبب إصابة داخلية", "إعطاؤه ماء والانتظار"], correct: 1 },
  ],
