...
export default function CleaningReports() {
  ...
  async function load() {
    try {
      ...
      const data = await call(`/api/reports?type=sweets_truck_daily_cleaning`);
              ...
              <div style={headerCard}>
                ...
                <div style={headerGrid}>
                  ...
                  <div style={headBox}>
                    ...
                    <div style={headValue}>{dayData.meta.documentNo || "SW-SAN-TDCL-01"}</div>
                  </div>
                  <div style={headBox}>
                    ...
                    <thead>
                      <tr>
                        {[
                          ...
                          "Shelves / tray racks","Truck pallets","Cake boxes / crates","Informed to","Remarks"
