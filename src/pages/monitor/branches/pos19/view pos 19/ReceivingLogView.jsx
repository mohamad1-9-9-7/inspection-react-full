// src/pages/monitor/branches/pos19/view pos 19/ReceivingLogView.jsx
...
export default function ReceivingLogView() {
  ...
  function exportJSON() {
    ...
    a.href = url;
    a.download = `POS19_ReceivingLog_${record?.payload?.reportDate || date}.json`;
    a.click();
  ...
  function fallbackCSV(p) {
    ...
    a.download = `POS19_ReceivingLog_${p.reportDate || date}.csv`;
    a.click();
