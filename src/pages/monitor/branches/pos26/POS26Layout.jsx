...
export default function POS26Layout() {
  ...
  useEffect(() => {
    ...
    let changed = false;
    if (!qs.get("branch")) { qs.set("branch", "POS 26"); changed = true; }
    if (!qs.get("source")) { qs.set("source", "pos26-tabs"); changed = true; }
  ...
  const renderContent = () => activeTab === "shipments" ? (
    <div style={{ background:"#fafafa", border:"1.5px solid #e5e7eb", borderRadius:12,
    ...
    <div style={{ minHeight:"100vh", padding:"2rem",
      ...
      <div style={{ background:"#fff", borderRadius:16, padding:"2rem",
        ...
        <div style={{ marginBottom:"1.5rem" }}>
          <h2 style={{ fontSize:"1.9rem", marginBottom:".5rem", color:"#1f2937" }}>📋 POS 26 — Operations Inputs</h2>
