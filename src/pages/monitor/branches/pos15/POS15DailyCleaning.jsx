...
const sections = [
  ...
  {
    title: "DISPLAY CHILLER",
    items: [
      "Propper arrangement of meat",
      "Shelves",
      "Display glass and inside",
      "Door",
    ],
  },
  {
  ...
  },
  {
    ...
    items: ["Mincer", "Wrapping Machine", "Bonesaw Machine"],
  },
  {
...
export default function POS15DailyCleaning() {
