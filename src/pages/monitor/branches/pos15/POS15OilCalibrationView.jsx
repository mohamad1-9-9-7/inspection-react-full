// src/pages/monitor/branches/pos15/POS15OilCalibrationView.jsx
import React, { useEffect, useMemo, useState } from "react";

const API_BASE =
  process.env.REACT_APP_API_URL || "https://inspection-server-4nvj.onrender.com";

export default function POS15OilCalibrationView() {
  ...
  const q = useMemo(() => {
    ...
    p.set("type", "pos15_oil_calibration");
    p.set("branch", "POS 15");
  ...
  return (
    <div>
      <h3 style={{ marginTop: 0, color: "#1f2937" }}>🛢️ Oil Calibration — POS 15</h3>
...
/* ====== Sub-components & styles محليًا داخل نفس الملف ====== */
    ...
    <div style={card}>
      <div style={cardHead}>
        <div style={{ fontWeight: 800, color: "#111827" }}>
          Date: {fmtDate(p.reportDate) || "—"}
        </div>
        <div style={{ color: "#6b7280", fontSize: 14 }}>
          Checked: <strong>{p.checkedBy || "—"}</strong> &nbsp;|&nbsp; Verified:{" "}
          <strong>{p.verifiedBy || "—"}</strong>
        </div>
