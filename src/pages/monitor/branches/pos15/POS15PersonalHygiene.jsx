// src/pages/monitor/branches/pos15/POS15PersonalHygiene.jsx
// Personal Hygiene input — POS 15
...
export default function POS15PersonalHygiene() {
  const [searchParams] = useSearchParams();
  const branchFromURL = searchParams.get("branch");
  const branch = branchFromURL || "POS 15";
