...
export const RECEIVING_GUIDANCE = [
  ...
  { kind: "tip",
    en: "Never leave the invoice number or the country of origin blank. Traceability is rebuilt from those two fields when something is recalled.",
    ar: "لا تترك رقم الفاتورة ولا بلد المنشأ فاضيين. التتبّع بينبنى من هالحقلين لما يصير سحب منتج." },
  { kind: "tip",
