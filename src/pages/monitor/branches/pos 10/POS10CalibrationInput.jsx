...
export default function POS10CalibrationInput() {
  ...
  async function handleSave() {
    try {
      ...
      const res = await fetch(`${API_BASE}/api/reports`, {
        ...
        body: JSON.stringify({ type: TYPE, payload: form }),
      });
      ...
      // إغلاق تلقائي بعد 1.4 ثانية
      setTimeout(() => closeModal(), 1400);

      // إعادة تهيئة بسيطة (يبقي تاريخ التقرير)
      setForm((s) => ({
        ...s,
        entries: [
          {
  ...
  return (
    <div style={wrap}>
      ...
      >
        CALIBRATION — {form.branch || "POS 10"}
      </div>
      ...
      {modal.open && (
        <div style={modalOverlay}>
          <div style={{ ...modalBox, borderTopColor:
