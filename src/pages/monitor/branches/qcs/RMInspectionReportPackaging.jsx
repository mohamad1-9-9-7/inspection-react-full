...
export default function RMInspectionReportPackaging() {
  ...
  /* ===== Existing report for the chosen date =====
     Saving used to be blocked outright when the day already had a record.
     The existing one is now offered for editing instead. */
            ...
            {dateMsg ? (
              <div
                style={{
                  ...
                  fontSize: 12,
                  fontWeight: 800,
                  color: dateCheckLoading || existingId ? COLORS.warn : COLORS.ok,
                }}
              >
                <span>{dateMsg}</span>
