// src/pages/monitor/branches/production/_shared/PrintStyles.jsx
// Global print-friendly styles for all Production reports.
// Inject this component once at the top level of PRDReportsView.
// When the browser prints, the page auto-adapts to A4 with minimal colors.
...
const PRINT_CSS = `
  @media print {
    ...
    * {
    ...
    /* ── Report Header (PRDReportHeader) — downgrade colors ── */
    .prd-rh-banner {
      background: #fff !important;
      color: #000 !important;
    ...
    .dm-section-icon,
    .dmv-panel-icon { display: none !important; }
    .dm-ccp-badge,
    .dmv-ccp {
      background: #fff !important;
      color: #000 !important;
    ...
    /* Progress bar → text */
    .dm-progress { display: none !important; }
