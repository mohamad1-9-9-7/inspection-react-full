...
const sections = [
  ...
  },
  {
    ...
    items: ["Floors", "Drainage", "Proper arrangement of Products", "Door"],
  },
  {
    title: "DISPLAY AREA",
    items: ["Floors", "Walls/Floors", "Display chillers", "Glass"],
  },
  {
    title: "MACHINE CLEANLINESS",
    items: ["Mincer", "Wrapping Machine", "Bone saw Machine", "Vacuum Machine"],
  },
  {
    title: "PACKING STORE",
...
export default function POS11DailyCleaning() {
  const [searchParams] = useSearchParams();
  const branch = searchParams.get("branch") || "POS 11";
  ...
  return (
    <div style={{ padding: "1.5rem", background: "#fff", borderRadius: 12 }}>
      {/* ===== ترويسة موحدة AL MAWASHI — ثابتة بدون تاريخ ===== */}
      <table
        style={{
          width: "100%",
      ...
      >
        TRANS EMIRATES LIVESTOCK (AL AIN BUTCHERY) — CLEANING CHECKLIST ({branch})
      </div>

      {/* Date & Time — خارج الترويسة */}
      <div
        style={{
          marginBottom: "1rem",
          display: "flex",
